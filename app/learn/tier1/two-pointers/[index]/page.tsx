  ...
  return (
    <div style={{ ...S, height: "100vh", background: "#0a0a0a", display: "flex", flexDirection: "column", overflow: "hidden", position: "relative" }}>
      ...
      <div style={{
        ...
        <Link href="/learn/tier1/two-pointers" style={{ textDecoration: "none" }}>
          <span style={{ fontSize: 10, color: "#374151", cursor: "pointer", letterSpacing: "0.08em" }}>← TP</span>
        </Link>
        <button
        ...
        >
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 14, maxWidth: 580, margin: "0 auto" }}>
            ...
            <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
              ...
              {idx < 8 && (
                <Link href={`/learn/tier1/two-pointers/${idx + 1}`} style={{ textDecoration: "none" }}>
                  <button style={{
                    padding: "8px 16px",
                    background: "rgba(244,63,94,0.1)", border: "1px solid rgba(244,63,94,0.4)",
                    borderRadius: 4, cursor: "pointer", fontSize: 10, color: "#f43f5e",
                    fontFamily: "inherit", letterSpacing: "0.06em",
                  }}>
                    NEXT →
                  </button>
