...
export const BT_PROBLEMS: BTProblem[] = [
  ...
  { index: 5, title: "Six Queens", difficulty: "Medium", free: true, leetcodeRef: "51", insightTitle: "N-Queens: Scaling Up", insight: "6x6 board has 4 solutions vs 92 for 8x8. The constraint propagation is the same — row, column, diagonal checks — but the search tree is deeper and pruning matters more.", mechanic: "placement" },
