  ...
  return (
    <div style={{ ...S, height: "100vh", background: "#0a0a0a", display: "flex", flexDirection: "column", overflow: "hidden", position: "relative" }}>
      <div style={{
        ...
        <Link href="/learn/tier1/dynamic-programming" style={{ textDecoration: "none" }}>
          <span style={{ fontSize: 10, color: "#374151", cursor: "pointer", letterSpacing: "0.08em" }}>← DP</span>
        </Link>
        <button
        ...
        >
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 14, maxWidth: 580, margin: "0 auto" }}>
            ...
            <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
              ...
              {idx < 8 && (
                <Link href={`/learn/tier1/dynamic-programming/${idx + 1}`} style={{ textDecoration: "none" }}>
                  <button style={{
                    padding: "8px 16px",
                    background: `rgba(129,140,248,0.1)`, border: `1px solid rgba(129,140,248,0.4)`,
                    borderRadius: 4, cursor: "pointer", fontSize: 10, color: ACCENT,
                    fontFamily: "inherit", letterSpacing: "0.06em",
                  }}>
                    NEXT →
                  </button>
